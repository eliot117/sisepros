...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-cyan navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <!--<li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Captura Ficha</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Consulta Ficha</a>
      </li>-->
    </ul>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="{{ asset('img/pemex3.jpg') }}" alt="Pemex Logo" class="brand-image img-fluid elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Examen Psicometro</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="#" class="nav-link">
              ...
              <p>Evaluadores <i class="right fas fa-angle-left"></i></p>
            </a>
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('evaluators.index') }}" class="nav-link">
  ...
  <footer class="main-footer">
    <!-- Default to the left -->
    <strong>Copyright &copy; 2021 Jessica Zapata.</strong>
  </footer>
</div>
<!-- ./wrapper -->
